...
export const ParcelsToStoreDataDisplay = () => {
    ...
    const columns = [
        {field: 'id', headerName: 'Order ID', headerClassName: 'super-app-theme--header', width: 85},
        {
            ...
            width: 148,
            renderCell: (params) => <StationParcelsStorageButtonRenderer row={params.row}
                                                                         updateFetchFlag={updateFetchFlag}/>
        },
        {
        ...
        {
            field: 'companyName',
            headerName: 'Parcel Hub Company Name',
            headerClassName: 'super-app-theme--header',
            width: 305
        },
